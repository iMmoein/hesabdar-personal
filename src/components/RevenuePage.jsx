...
export function RevenuePage({ currency, isDark }) {
  ...
  const loadTransactions = useCallback(async () => {
    try {
      setLoading(true)
      const allRevenue = await db.transactions.where('type').equals('revenue').toArray()
        ...
        <div className="px-4 pt-4 pb-2">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
              <div className="w-9 h-9 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center shadow-glow-green">
          ...
          <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-3xl p-5 mb-3 shadow-elevated relative overflow-hidden">
            ...
            <div className="relative">
              <div className="text-white/80 text-sm mb-1">مجموع درآمد</div>
